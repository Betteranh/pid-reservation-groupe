...
CREATE TABLE `artists` (
  ...
  `troupe_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_artist_troupe` (`troupe_id`),
  CONSTRAINT `fk_artist_troupe` FOREIGN KEY (`troupe_id`) REFERENCES `troupes` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `artists` VALUES (1,'Daniel','Marcelin',1),(2,'Philippe','Laurent',2),(3,'Marius','Von Mayenburg',3),(4,'Olivier','Boudon',4),(5,'Anne Marie','Loop',1),(6,'Pietro','Varasso',2),(7,'Laurent','Caron',3),(8,'Élena','Perez',4),(9,'Guillaume','Alexandre',1),(10,'Claude','Semal',2),(11,'Laurence','Warin',3),(12,'Pierre','Wayburn',4),(13,'Gwendoline','Gauthier',1),(14,'Jacques','Brel',2),(15,'Salvatore','Adamo',3),(16,'Stromae','Cowboy',4),(17,'Angèle','Van Laeken',1),(18,'Arno','Hintjens',2),(19,'Alex','Callier',3),(20,'Wouter','De Backer',4),(21,'Jean','Dupont',1),(22,'Marie','Martin',2),(23,'Paul','Moreau',3),(24,'Sophie','Lefèvre',4),(25,'Antoine','Petit',1),(26,'Claire','Laurent',2),(27,'Nicolas','Roche',3),(28,'Émilie','Dubois',4),(29,'Guillaume','Durand',1),(30,'Camille','Leroy',2),(31,'Jan','De Vries',3),(32,'Piet','Janssen',4),(33,'Karel','De Bruin',1),(34,'Femke','Visser',2),(35,'Bram','Smit',3),(36,'Sanne','Bakker',4),(37,'Tom','Verhoeven',1),(38,'Lotte','De Wit',2),(39,'Daan','Van Dijk',3),(40,'Emma','De Lange',4),(41,'Michael','Smith',1),(42,'Jennifer','Johnson',2),(43,'William','Brown',3),(44,'Elizabeth','Davis',4),(45,'James','Wilson',1),(46,'Mary','Taylor',2),(47,'Robert','Anderson',2),(48,'Patricia','Thomas',3),(49,'David','Jackson',4),(50,'Linda','White',1),(51,'Martin','Robinson',2),(52,'Sophie','Edwards',3),(53,'Alexandre','Bernard',4),(54,'Chloé','Fontaine',1),(55,'Laurent','Marchand',2),(56,'Isabelle','Garnier',3),(57,'Sébastien','Girard',4),(58,'Manon','Petitjean',1),(59,'Olivier','Dupuis',2),(60,'Juliette','Renault',3),(61,'Hugo','Rousseau',4);
...
INSERT INTO `flyway_schema_history` VALUES (1,'1.1','create troupes table','SQL','V1_1__create_troupes_table.sql',-1961101759,'root','2025-05-21 17:10:53',43,1),(2,'1.2','insert troupes table','SQL','V1_2__insert_troupes_table.sql',1225390203,'root','2025-05-21 17:10:53',9,1),(3,'1.3','create artists table','SQL','V1_3__create_artists_table.sql',-973999389,'root','2025-05-21 17:10:54',729,1),(4,'1.4','insert artists table','SQL','V1_4__insert_artists_table.sql',694162296,'root','2025-05-21 17:10:54',7,1),(5,'2.1','create users table','SQL','V2_1__create_users_table.sql',433411370,'root','2025-05-21 17:10:54',28,1),(6,'2.2','insert users table','SQL','V2_2__insert_users_table.sql',1830020814,'root','2025-05-21 17:10:54',8,1),(7,'3.1','create types table','SQL','V3_1__create_types_table.sql',-714946083,'root','2025-05-21 17:10:54',22,1),(8,'3.2','insert types table','SQL','V3_2__insert_types_table.sql',-1224026954,'root','2025-05-21 17:10:54',6,1),(9,'4.1','create localities table','SQL','V4_1__create_localities_table.sql',877901794,'root','2025-05-21 17:10:54',24,1),(10,'4.2','insert localities table','SQL','V4_2__insert_localities_table.sql',-694845285,'root','2025-05-21 17:10:54',5,1),(11,'5.1','create roles table','SQL','V5_1__create_roles_table.sql',-250331844,'root','2025-05-21 17:10:54',25,1),(12,'5.2','insert roles table','SQL','V5_2__insert_roles_table.sql',-1425221773,'root','2025-05-21 17:10:54',6,1),(13,'6.1','create locations table','SQL','V6_1__create_locations_table.sql',613662933,'root','2025-05-21 17:10:54',118,1),(14,'6.2','insert locations table','SQL','V6_2__insert_locations_table.sql',-2107314338,'root','2025-05-21 17:10:54',5,1),(15,'7.1','create shows table','SQL','V7_1__create_shows_table.sql',-251778180,'root','2025-05-21 17:10:55',112,1),(16,'7.2','insert shows table','SQL','V7_2__insert_shows_table.sql',221623019,'root','2025-05-21 17:10:55',4,1),(17,'8.1','create representations table','SQL','V8_1__create_representations_table.sql',-326404921,'root','2025-05-21 17:10:55',174,1),(18,'8.2','insert representations table','SQL','V8_2__insert_representations_table.sql',1441833475,'root','2025-05-21 17:10:55',4,1),(19,'9.1','create artist type table','SQL','V9_1__create_artist_type_table.sql',-865740315,'root','2025-05-21 17:10:55',168,1),(20,'9.2','insert artist type table','SQL','V9_2__insert_artist_type_table.sql',1045350802,'root','2025-05-21 17:10:55',5,1),(21,'10.1','create artist type show table','SQL','V10_1__create_artist_type_show_table.sql',716058841,'root','2025-05-21 17:10:55',101,1),(22,'10.2','insert artist type show table','SQL','V10_2__insert_artist_type_show_table.sql',742901213,'root','2025-05-21 17:10:55',4,1),(23,'11.1','create user role table','SQL','V11_1__create_user_role_table.sql',1943854436,'root','2025-05-21 17:10:55',159,1),(24,'11.2','insert user role table','SQL','V11_2__insert_user_role_table.sql',-382620278,'root','2025-05-21 17:10:55',3,1),(25,'12.1','create reservations table','SQL','V12_1__create_reservations_table.sql',-933945556,'root','2025-05-21 17:10:55',84,1),(26,'12.2','insert reservations table','SQL','V12_2__insert_reservations_table.sql',399871119,'root','2025-05-21 17:10:55',6,1),(27,'13.1','create prices table','SQL','V13_1__create_prices_table.sql',-1676046384,'root','2025-05-21 17:10:56',37,1),(28,'13.2','insert prices table','SQL','V13_2__insert_prices_table.sql',-747473909,'root','2025-05-21 17:10:56',4,1),(29,'14.1','create representation reservation table','SQL','V14_1__create_representation_reservation_table.sql',-1813757770,'root','2025-05-21 17:10:56',117,1),(30,'15.1','create reviews table','SQL','V15_1__create_reviews_table.sql',-459061990,'root','2025-05-21 17:10:56',106,1),(31,'16.1','create show price table','SQL','V16_1__create_show_price_table.sql',284933353,'root','2025-05-21 17:10:56',108,1),(32,'16.2','insert show price table','SQL','V16_2__insert_show_price_table.sql',-775025755,'root','2025-05-21 17:10:56',4,1),(33,'17.1','create tags table','SQL','V17_1__create_tags_table.sql',357458051,'root','2025-05-21 17:10:56',14,1),(34,'17.2','insert tags table','SQL','V17_2__insert_tags_table.sql',2130966173,'root','2025-05-21 17:10:56',10,1),(35,'18.1','create show tag table','SQL','V18_1__create_show_tag_table.sql',386781069,'root','2025-05-21 17:10:56',10,1),(36,'19.1','create videos table','SQL','V19_1__create_videos_table.sql',-891588289,'root','2025-05-21 17:10:56',30,1),(37,'19.2','insert videos table','SQL','V19_2__insert_videos_table.sql',745622660,'root','2025-05-21 17:10:56',5,1);
...
INSERT INTO `tags` VALUES (1,'famille'),(2,'drame'),(3,'comédie'),(4,'jeune public'),(5,'musique'),(6,'classique'),(7,'aventure'),(8,'nouveauté');
...
INSERT INTO `troupes` VALUES (1,'La Troupe du Soleil','/images/logos/soleil.jpg'),(2,'Compagnie Lunaire','/images/logos/lune.jpg'),(3,'Les Artistes des nuages','/images/logos/nuage.jpg'),(4,'La Troupe des Éclairs','/images/logos/eclair.png');
...
CREATE TABLE `videos` (
  ...
  KEY `show_id` (`show_id`),
  CONSTRAINT `videos_ibfk_1` FOREIGN KEY (`show_id`) REFERENCES `shows` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `videos` VALUES (1,'Trailer Ayiti Test','https://youtu.be/cR-6b3KQkLU?si=_ydq4JAQ16tzHgDG',1,'Marcelin');
...
-- Dump completed on 2025-05-21 20:02:38
